package com.example.shoppingcenter.app_1;
 ...
 * @Version: 1.0
 */
public class ShoppingCenterAppInit implements BaseAppInit {
    @Override
    public boolean onInitSpeed() {
        Log.d("AppInit","ShoppingCenterAppInit onInitSpeed");
        return false;
    }

    @Override
    public boolean onInitLow() {
        Log.d("AppInit","ShoppingCenterAppInit onInitLow");
        return false;
    }
}
